...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-card-light dark:bg-card-dark border-b border-gray-200 dark:border-gray-800 shadow-sm transition-colors backdrop-blur-md bg-white/80 dark:bg-card-dark/80">
        ...
        <div className="flex items-center justify-between gap-4 lg:gap-8">
          <div className="flex items-center gap-3 shrink-0">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <h1 className="font-display text-gray-900 dark:text-white text-xl lg:text-2xl font-bold tracking-tight italic uppercase">
                GundamBase
              </h1>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={onOpenCart}
                className="relative p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors group"
              >
                <span
                  className={`material-symbols-outlined group-hover:text-primary ${
                    animateCart ? "scale-125 text-primary" : ""
